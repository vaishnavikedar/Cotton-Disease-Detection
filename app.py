...
# Define constants
data_dir = 'D:\\Cotton Project\\data'
image_size = 32
...
class ImageClassificationBase(nn.Module):
    ...
    def epoch_end(self, epoch, result):
        print(
            f"Epoch [{epoch}], train_loss: {result['train_loss']:.4f}, val_loss: {result['val_loss']:.4f}, val_acc: {result['val_acc']:.4f}")
...
model.load_state_dict(torch.load('D:\\Cotton Project\\modelCottonDemo.pth', map_location=device))
